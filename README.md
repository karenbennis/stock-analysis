...
* When the user enters "2018", the following output is rendered:
    ...
    NOTE: additional formatting for font and borders was applied which has not been mentioned in step 9.
...
#### Explanation of VBA
The macro *AllStocksAnalysisRefactor()* involves the following variables:
* **yearValue** (values = "2017" and "2018")
* **tickers()** (array of 12 tickers defined 'As String')
...
10. The code populates the output (for i = 0 to 11, i.e. for all 12 tickers) on the activated worksheet "All Stocks Analysis Refactored" as follows:
    - Under the heading "Ticker", populate the value for **tickers(i)**
    - Under the heading "Total Daily Volume", populate the value for **tickerVolume(i)**
    - Under the heading "Return", populate the value for the formula **tickerEndingPrice(i)** / **TickerStartingPrice(i)** - 1
...
* When the user enters "2017", the following output is rendered:
    ...
    - These are the same results as generated by *AllStocksAnalysis()*.
...
* When the user enters "2018", the following output is rendered:
    ...
    - These are the same results as generated by *AllStocksAnalysis()*.
    NOTE: additional formatting for font and borders was applied which has not been mentioned above.
